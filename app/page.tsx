...
const baseReadingTexts: ReadingText[] = [
  ...
  { id: "new-classmate", level: "A1", time: "4 мин", title: "A New Classmate", genre: "Школа", color: "yellow", mark: "✦", body: ["On Monday, a new student comes to Leo's class. Her name is Nora, and she is from Spain.", "At first, Nora looks a little nervous because she does not know anyone. Leo says hello and shows her the classroom, the library, and the cafeteria.", "At lunch, they talk about music, cats, and their favorite food. Nora likes the same band as Leo, so they have a lot to say.", "Before the bell rings, Leo asks Nora to sit with him tomorrow. She smiles and says that she would like that."] },
  { id: "rainy-afternoon", level: "A1", time: "4 мин", title: "A Rainy Afternoon", genre: "Дом", color: "coral", mark: "☂", body: ["It starts to rain after school, so Sam cannot play football outside. He feels disappointed when he looks at the gray sky.", "His sister Maya has an idea. She brings paper, colors, and an old box from the cupboard.", "Together they make a small city with houses, roads, trees, and a bright blue bus. Their cat walks through the paper streets and becomes a giant in the city.", "When their mother comes home, the rain has stopped. Sam does not mind because the afternoon was more fun than he expected."] },
  ...
  { id: "market-list", level: "A1", time: "4 мин", title: "The Market List", genre: "Еда", color: "sand", mark: "◌", body: ["Dad gives Lina a short list before they go to the market: apples, carrots, bread, cheese, and tea.", "The market is busy, and every stall has different colors and smells. Lina carefully reads the list and helps Dad choose the best apples.", "At the bread stall, an old woman gives Lina a small warm roll. Lina says thank you and puts it in her bag for later.", "At home, they make soup together. Lina checks the list again and feels proud because they did not forget anything."] },
  ...
  { id: "garden-project", level: "A2", time: "5 мин", title: "A Garden Project", genre: "Природа", color: "sand", mark: "✿", body: ["The empty space behind our apartment building used to be full of broken chairs and old boxes. Nobody wanted to spend time there.", "One spring, Mrs. Petrova asked the neighbors if they would help make a garden. Some people brought soil, some brought seeds, and the children painted small signs.", "For several weeks, everyone worked after dinner. The space slowly changed into a place with flowers, herbs, and two wooden benches.", "Now people drink coffee there in the mornings. The garden did not solve every problem in the building, but it gave the neighbors a reason to know one another."] },
  { id: "neighbor", level: "B1", time: "6 мин", title: "The New Neighbor", genre: "Рассказ", color: "forest", mark: "⌂", body: ["When Mr. Hale moved into the apartment upstairs, the building became quieter than usual. He never played music and rarely spoke to anyone.", "One evening, the elevator stopped between floors while I was carrying groceries. Mr. Hale was inside too. Instead of looking worried, he told me a funny story about getting lost in a museum in Prague.", "By the time the elevator began moving again, I had forgotten about the bags in my hands. He helped me carry them to my door and noticed the books on my table.", "After that evening, we always greeted each other in the hall. A few months later, he gave me a postcard from Prague and wrote, For the next unexpected journey."] },
  { id: "train-to-sea", level: "B1", time: "6 мин", title: "A Train to the Sea", genre: "Путешествия", color: "sand", mark: "≈", body: ["The train left before sunrise, carrying only a few sleepy passengers toward the coast. Elena had planned the trip for months, yet she still felt nervous when the city disappeared behind the fields.", "Across from her, an old man was drawing the changing view in a notebook. He explained that he traveled this route every spring because the light near the sea helped him paint.", "They spoke about places they wanted to see and places they had left behind. The man said that traveling was not always about finding something new; sometimes it helped people hear their own thoughts.", "When Elena finally stepped onto the platform, the air was cold and salty. She understood why he returned every year and felt ready to begin her own walk along the shore."] },
  ...
  { id: "old-camera", level: "B1", time: "6 мин", title: "The Old Camera", genre: "Семья", color: "yellow", mark: "◫", body: ["While cleaning the attic, Amir found his grandfather's camera in a wooden case. It was heavy, scratched, and still had a roll of film inside.", "His grandfather taught him how to hold it steady and wait before pressing the button. Unlike a phone, the camera could not show the picture immediately.", "They spent a weekend taking photographs of ordinary things: a bicycle in the rain, a market stall, and their neighbor's sleepy cat.", "When the film was developed, several pictures were blurry. Amir liked them anyway because each one held a small memory that could not be repeated exactly."] },
  { id: "quiet-cafe", level: "B1", time: "6 мин", title: "The Quiet Cafe", genre: "Работа", color: "coral", mark: "☕", body: ["A small cafe opened beside the station, and at first it was almost empty. The owner, Rosa, refused to play loud music or fill every table.", "She placed a shelf of second-hand books near the door and wrote a sign that said, Stay as long as you need.", "Students began coming to study there. Later, people who worked from home discovered the cafe, and the morning tables slowly filled with quiet conversations.", "Rosa said that she did not want to create the busiest place in town. She wanted to create a place where people could breathe before continuing their day."] },
...
const storyExtensions: Record<string, string> = {
  ...
  "garden-project": "By summer, the neighbors organize a picnic in the garden. Everyone brings one dish, and the children explain which flowers they planted. The once-empty space has become their favorite meeting place.",
  "neighbor": "The postcard made me laugh because Mr. Hale had drawn a tiny elevator on the back. I placed it beside my books, where it reminds me that a short conversation can change a whole building.",
  "train-to-sea": "Elena spent the day walking slowly along the shore and collecting smooth stones. In the evening, she opened her notebook and wrote down the colors of the water before they faded from memory.",
  ...
  "old-camera": "Amir chose his favorite photograph and gave it to his grandfather in a simple frame. His grandfather said that the imperfect picture was the best one because it showed the moment honestly.",
  "quiet-cafe": "Rosa began leaving a blank notebook near the books. Visitors wrote short notes about a song, a journey, or a difficult day. Soon the cafe had its own quiet collection of stories.",
...
const strictBodies: Record<string, string[]> = {
  "morning-walk": [
    ...
    "She puts on her blue shoes and takes a small bottle of water. Her mom says, “Have a nice time.” Mia smiles and walks to the park near her home.",
    ...
    "After one hour, Mia walks home. She feels happy and tired. At home, she makes tea and tells her mom about the dog, the birds, and the lake. She smiles again."
  ],
  "new-classmate": [
  ...
  "rainy-afternoon": [
    ...
    "Sam feels sad. His sister Maya comes into the room with paper, colors, and an old box. The box is big and brown. She has an idea for a game.",
    ...
    "Later, Mom makes hot tea and puts small cakes on a plate. The rain is still on the window, but Sam is happy. He wants to make more houses tomorrow. They are happy."
  ],
  "green-bicycle": [
    ...
    "She needs bread for her mom, so she rides to the small shop near the park. She has no car today. The bike is fast, and the morning air is warm.",
  ...
  "market-list": [
    "On Saturday morning, Dad gives Lina a small list. It says apples, carrots, bread, cheese, milk, and tea. Mom is at home, so Dad and Lina go alone. They walk to the market together.",
  ...
  "letter-from-london": [
    ...
    "Tomorrow, we are going to see a play. My aunt says the theater is old and beautiful. After the play, we will have dinner in a small restaurant.",
  ...
  "lost-recipe": [
    ...
    "Dad checks the shelf above the fridge. Mom looks in the book where she keeps phone numbers. We look in every room.",
  ...
  "blue-umbrella": [
    ...
    "When she gets to her building, she sees only her bag. The umbrella is not with her. She left it on the bus. Nadia feels sad because it is her favorite umbrella.",
  ...
  "garden-project": [
    ...
    "One spring day, some neighbors meet outside. They want to make a small garden. They bring soil, seeds, water, and simple tools. Some people bring food for lunch.",
    ...
    "Now the garden is a good place for the street. Neighbors talk while children play. We know more names than before, and we want to make it bigger next year. They are happy with it."
  ],
  "neighbor": [
    "When Mr Hale moved into the apartment above mine, most people in our building knew very little about him. He left early, returned late, and never stayed long in the hall.",
    "One Saturday, the elevator stopped just as I carried bags of food upstairs. Mr Hale was there with a box of books, so we waited together for help.",
    "At first we spoke only about the broken elevator. Then he noticed a guidebook in my bag and asked whether I planned a trip. He also showed me a small cafe near the old bridge.",
    ...
    "The elevator soon worked again, but our conversation did not end there. After that day, we often shared news in the hall and sometimes helped each other with shopping. They were friendly."
  ],
  "train-to-sea": [
    ...
    "He said he traveled this route every spring, but he was returning home after visiting his daughter. Elena asked about the places on his page.",
    "They talked quietly about favorite journeys, missed trains, and towns they hoped to see one day. The hours passed more quickly than Elena expected.",
  ...
  "open-window": [
    "Every evening, I saw a warm light in the apartment opposite my kitchen. A woman sat by an open window and wrote in a notebook.",
    "I often wondered what she wrote, but I never asked. We only smiled when we met near the mailboxes downstairs. She explained that she wrote after work because the quiet room helped her think. I told her about the books I enjoyed.",
  ...
  "quiet-cafe": [
    "A small cafe opened beside the station, but few people noticed it at first. It had plain tables, soft lights, and no loud music.",
    ...
    "Rosa learned their names and asked about their days. The cafe stayed quiet, but it became a friendly part of the neighborhood for everyone there, including people who sometimes felt lonely after work. It gave people a quiet place."
  ],
  "first-hike": [
  ...
  "small-library": [
    ...
    "When the council announced plans to close it, the neighborhood organized a reading festival. Local writers came, children read short stories aloud, and shop owners gave food for the event. The protest was calm, but it showed how strongly people valued the building.",
  ...
  "map-of-voices": [
    "For her university project, Irina recorded the everyday sounds of her neighborhood: shutters opening, children in a courtyard, a tram turning at the corner, and voices from small shops.",
  ...
  "empty-chair": [
    "In the community center, one chair always remained empty during the weekly writing group. It stood near the window, although nobody was ever asked to sit there.",
