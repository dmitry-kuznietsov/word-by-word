...
export default function Home() {
  ...
  function rateTranslation(rating: "up" | "down") {
    if (!activeWord) return;
    setRatings((current) => ({ ...current, [activeWord.cacheKey]: rating }));
    setToast(rating === "up" ? "Спасибо! Перевод отмечен как верный" : "Спасибо! Перевод отмечен для проверки");
  }
